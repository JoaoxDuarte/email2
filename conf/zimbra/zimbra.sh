...
# 18. Create domain: [emailserverws.rhelst.intra] rhelst.intra <Enter>
# 19. Address unconfigured (**) items  (? - help) 6 <Enter>
#	19.1 Select, or 'r' for previous menu [r] 4 <Enter>
#	19.2 Password for admin@rhelst.intra (min 6 characters): [XXXXXX] rhelst@2018 <Enter>
...
# 01. Acessar a URL: https://mail.rhelst.intra:7071
# 02. Nome do usuário: admin
# 03. Senha: rhelst@2018 <Login>
#
# INFORMAÇÕES QUE SERÃO SOLICITADAS VIA WEB (NAVEGADOR) DO ZIMBRA WEBMAIL:
# 01. Acessar a URL: https://mail.rhelst.intra
# 02. Nome do usuário: admin
# 03. Senha: rhelst@2018
...
# Vídeo de configuração do OpenSSH no GNU/Linux Ubuntu Server 20.04.x LTS: https://www.youtube.com/watch?v=ecuol8Uf1EE&t
